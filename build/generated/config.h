...
#define SOLIB_EXT ".so"
#define BUILT_WITH  "CMAKE GNU GNU PKGCONFIG HDRHISTOGRAM ZLIB CURL ZSTD LIBDL PLUGINS SSL SASL_SCRAM SASL_OAUTHBEARER SASL_CYRUS LZ4_EXT C11THREADS CRC32C_HW SNAPPY SOCKEM"
